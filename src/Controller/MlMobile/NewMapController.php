...
class NewMapController extends AppController 
{
...
//            if(!$shop_data1){
//                if($shop_nm){
//                     echo '<p  style="text-align:center;color:green; padding-top:50px;">【'.$shop_nm.'にヒットする店舗はありません。別の内容で検索してください。】</p>';   
//                }
//                if($shop_add){
//                    echo '【'.$shop_add.'にヒットする店舗はありません。別の内容で検索してください。】';    
//                }
//            }

    ...
    <div style="text-align:center;width: 60%;margin-left: 25%">
        <div id="sb-site1" style="text-align:left">
            ...
            <p style="text-align:center">
                <font color="red" size="5"><?php $ERR_PHONE ?></font>
            </p>

            <label class="fieldbox">
                店舗名<font color="red">（必須）</font><br />
                <input id="shop_nm" class="input_box" name="shop_nm" type="text" onchange="btn_click('<?= h($shop_data[0]['shop_nm']) ?>')" value="<?= h($shop_data[0]['shop_nm']) ?>" required maxlength="60">
            </label>
            <br />
            <label class="fieldbox">
                店舗名カナ<br />
                <input id="shop_kn" name="shop_kn" class="input_box" type="text" value="<?= h($shop_data[0]['shop_kn']) ?>" maxlength="60">
            </label>
            <br />
            <label class="fieldbox">
                電話番号<font color="red">（必須）</font><br />
                <input id="shop_phone" name="shop_phone" type="text" value="<?= h($shop_data[0]['shop_phone']) ?>" maxlength="15" placeholder="ハイフン無し半角数字で入力してください">
            </label>
            <br />
            <label class="fieldbox">
                FAX番号<br />
                <input id="shop_fax" name="shop_fax" type="text" value="<?= h($shop_data[0]['shop_fax']) ?>" maxlength="15" placeholder="ハイフン無し半角数字で入力してください">
            </label>
            <br />
            <label class="fieldbox">
                郵便番号<font color="red">（必須）</font><br />
                <input id="shop_postcd" name="shop_postcd" type="text" value="<?= h($shop_data[0]['shop_postcd']) ?>" maxlength="8" placeholder="ハイフン無し半角数字で入力してください">
            </label>
            <br />
            <label class="fieldbox">
            ...
            <label class="fieldbox">
                ...
                <input id="shop_add2" name="shop_add2" class="input_box" type="text" value="<?= h($shop_data[0]['shop_add2']) ?>" maxlength="60" placeholder="市区町村を入力してください">
            </label>
            <br />
            <label class="fieldbox">
                番地以降の住所<font color="red">（必須）</font><br />
                <input id="shop_add3" name="shop_add3" class="input_box" type="text" value="<?= h($shop_data[0]['shop_add3']) ?>" maxlength="60" placeholder="番地以降の住所を入力してください">
            </label><br>
            ...
            <label class="fieldbox">
                ...
                <input id="shop_pw" name="shop_pw" type="password" value="<?= h($shop_data[0]['shop_pw']) ?>" maxlength="8" placeholder="半角英数字8字以内で入力してください">
            ...
            <label class="fieldbox">
                ...
                <input id="pass_confirm" name="pass_confirm" type="password" value="<?= h($shop_data[0]['shop_pw']) ?>" maxlength="8">
            ...
            <label class="fieldbox">
                <input id="url_hp" name="url_hp" class="input_box" type="text" value="<?= h($shop_data[0]['url_hp']) ?>" maxlength="500" placeholder="ホームページのURL">
            </label><br />
            <label class="fieldbox">
                <input id="url_sns1" name="url_sns1" class="input_box" type="text" value="<?= h($shop_data[0]['url_sns1']) ?>" maxlength="500" placeholder="LINEのURL">
            </label><br />
            <label class="fieldbox">
                <input id="url_sns2" name="url_sns2" class="input_box" type="text" value="<?= h($shop_data[0]['url_sns2']) ?>" maxlength="500" placeholder="InstagramのURL">
            </label>
            <label class="fieldbox">
                <input id="url_sns3" name="url_sns3" class="input_box" type="text" value="<?= h($shop_data[0]['url_sns3']) ?>" maxlength="500" placeholder="TwitterのURL">
            </label> <br />
            <label class="fieldbox">
                <input id="url_sns4" name="url_sns4" class="input_box" type="text" value="<?= h($shop_data[0]['url_sns4']) ?>" maxlength="500" placeholder="GoogleMapのURL">
            </label> <br />
            ...
            <label class="fieldbox">
                取扱商品:
                <input id="goods" name="goods" type="text" maxlength="60" value="<?= h($shop_data[0]['goods']) ?>" placeholder="主な取扱商品やメニューを入力してください">
            </label>
            <br />
            <label class="fieldbox1" style=" height: 30%; width  : 50%; resize : none;">
                店舗紹介<br />
                <input id="free_text" name="free_text" type="text" value="<?= h($shop_data[0]['free_text']) ?>" maxlength="100" placeholder="おすすめ商品やメニューがあればご自由に入力ください。(200字以内)" style=" width:80%; resize : none;">
            </label>
            <br />
            <label>
                有料会員<br>
            ...
            <label class="fieldbox">
                バーコード種類　:
                <select name="barcode_kbn">
                    <option></option>
                    <?php
                    foreach ($barcode_kbns as $data) {
                        $selected = '';
                        if ($data['name'] == $shop_data[0]['barcode_kbn']) {
                            $selected = 'selected';
                        } else {
                            $selected = '""';
                        }

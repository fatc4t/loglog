...
<html>
  <head>
    <?php echo $this->Html->css('mobilemap_1'); ?> 
    <meta charset="utf-8">
    ...
    <?php } ?>
        ...
        function setmarker1(lon,lat,shop_cd,user_cd){
            ...
            L.marker([lat, lon],{icon: L.icon({iconUrl:"/loglog/webroot/img/mappin_ittabasho_35.png",iconAnchor:[15,15]})}).addTo(map).on('click', function (e) {    
                  popup
                      .setLatLng(e.latlng)
                      .setContent("<iframe class = 'frame_size' scrolling='no' allowtransparency='true' frameborder='0' src= 'https://loglog.biz/loglog/MlMobile/mapshop_1?shop_cd="+shop_cd+"&user_cd="+user_cd+"'>店舗詳細</iframe>" )
                      .openOn(map);
            });
        }

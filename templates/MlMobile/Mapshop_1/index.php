<?php echo $this->Html->css('mobileparts_1'); ?> 
...
<div class="block_img">
    ...
    <div class="block_info">
        <div class="block_add" >
                ...
                if($coupon_data){ ?>
                <br /><br />
                <a target="_top" class="coupon" href="https://loglog.biz/loglog/ml-mobile/Testcpn?user_cd=<?= h($user_cd) ?>&shop_cd=<?= h($shop_data[0]['shop_cd']) ?>">お得なクーポンあり！</a>                  
                <?php } ?> 

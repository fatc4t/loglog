...
<head>
    ...
    <meta charset="utf-8">
    <link rel="stylesheet" href="/loglog/webroot/css/leaflet/leaflet.css" crossorigin="" />
    <script src="/loglog/webroot/js/leaflet/leaflet.js" crossorigin=""></script>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function setmarker1(lon, lat, shop_cd, user_cd) {
            ...
            L.marker([lat, lon], {
                icon: L.icon({
                    iconUrl: "/loglog/webroot/img/raiten_star.svg",
                    iconAnchor: [25, 25]
                })
            }).addTo(map).on('click', function(e) {
                popup
                    .setLatLng(e.latlng)
                    .setContent("<iframe class = 'frame_size' scrolling='yes' allowtransparency='true' frameborder='0' src= 'https://loglog.biz/loglog/MlMobile/mapshop?shop_cd=" + shop_cd + "&user_cd=" + user_cd + "'>店舗詳細</iframe>")
                    .openOn(map);
            });
        }
        ...
        function setmarker2(lon, lat, shop_cd, user_cd) {
            ...
            L.marker([lat, lon], {
                icon: L.icon({
                    iconUrl: "/loglog/webroot/img/shop_blue.svg",
                    iconAnchor: [25, 25]
                })
            }).addTo(map).on('click', function(e) {
                popup
